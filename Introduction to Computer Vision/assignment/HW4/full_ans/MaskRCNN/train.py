...
model.load_state_dict(torch.load('/Users/peiyuliu/Desktop/PKU-Undergraduate-Course-Public/计算机视觉导论(Introduction to Computer Vision)/assignments/HW4/assignment4_ans/MaskRCNN/intro2cv_maskrcnn_pretrained.pth', map_location='cpu'))

dataset = MultiShapeDataset(10) # original size is 10

torch.manual_seed(2025)  # changed to 2025 from 233
