...
{
       0,    59,    59,    77,    89,    97,   105,   113,   121,   126,
     135,   140,   149,   154,   159,   167
};
#endif
...
static const char *const yytname[] =
{
  ...
  "Exp", "UnaryExp", "PrimaryExp", "UnaryOp", "Number", YY_NULLPTR
};
...
#line 59 "/root/compiler/src/sysy.y"
    ...
    comp_unit_ast->func_def_ast = std::unique_ptr<FuncDefAST>(static_cast<FuncDefAST*>((yyvsp[0].ast_val)));
    ast = std::move(comp_unit_ast);
  }
#line 1106 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 77 "/root/compiler/src/sysy.y"
    ...
    ast->func_type_ast = unique_ptr<FuncTypeAST>(static_cast<FuncTypeAST*>((yyvsp[-4].ast_val)));
    ast->func_name = *unique_ptr<string>((yyvsp[-3].str_val));
    ast->block_ast = unique_ptr<BlockAST>(static_cast<BlockAST*>((yyvsp[0].ast_val)));
    (yyval.ast_val) = ast;
  }
#line 1119 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1129 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 97 "/root/compiler/src/sysy.y"
    ...
    ast->stmt_ast = unique_ptr<StmtAST>(static_cast<StmtAST*>((yyvsp[-1].ast_val)));
    (yyval.ast_val) = ast;
  }
...
#line 105 "/root/compiler/src/sysy.y"
    ...
    ast->exp_ast = unique_ptr<ExpAST>(static_cast<ExpAST*>((yyvsp[-1].ast_val)));
    (yyval.ast_val) = ast;
  }
#line 1149 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 113 "/root/compiler/src/sysy.y"
             {
    auto ast = new ExpAST();
    ast->unary_exp_ast = unique_ptr<UnaryExpAST>(static_cast<UnaryExpAST*>((yyvsp[0].ast_val)));
    (yyval.ast_val) = ast;
  }
#line 1159 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 121 "/root/compiler/src/sysy.y"
    ...
    ast->primary_exp_ast = unique_ptr<PrimaryExpAST>(static_cast<PrimaryExpAST*>((yyvsp[0].ast_val)));
    (yyval.ast_val) = ast;
  }
#line 1169 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 126 "/root/compiler/src/sysy.y"
                     {
    auto ast = new UnaryExpAST();
    ast->unary_op_ast = unique_ptr<UnaryOpAST>(static_cast<UnaryOpAST*>((yyvsp[-1].ast_val)));
    ast->unary_exp_ast = unique_ptr<UnaryExpAST>(static_cast<UnaryExpAST*>((yyvsp[0].ast_val)));
    (yyval.ast_val) = ast;
  }
#line 1180 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1190 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 140 "/root/compiler/src/sysy.y"
    ...
    ast->number_ast->number = (yyvsp[0].int_val);
    (yyval.ast_val) = ast;
  }
#line 1201 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1211 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1221 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1231 "/root/compiler/build/sysy.tab.cpp"
    break;
...
#line 1239 "/root/compiler/build/sysy.tab.cpp"
    break;


#line 1243 "/root/compiler/build/sysy.tab.cpp"
